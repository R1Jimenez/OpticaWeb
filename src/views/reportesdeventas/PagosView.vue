...
<template>
    <div class="PagosPrinc">
        <Header />
        <div class="PagosCont">
            <NavBar />
            <div class="PagosUsages">
                <div class="PagosEdsPrinc">
                    <div class="EdsPagosPHeader">
                        <span>Reportes - Pagos - Tickets</span>
                    </div>
                    <div class="FoGridP">
                        <text>Formato:</text>
                        <div class="rowforP">
                            <div class="minrowforP">
                                <input
                                    type="radio"
                                    class="check7"
