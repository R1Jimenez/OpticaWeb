...
<template>
    <div class="VentasPlazPrinc">
        <Header />
        <div class="VentPLazCont">
            <NavBar />
            <div class="VentPlazUsages">
                <div class="VentPlazEdsPrinc">
                    <div class="EdsVPHeader">
                        <span>Reportes - Cuentas por Cobrar</span>
                    </div>
                    <div class="FoGridVP">
                        <text>Formato:</text>
                        <div class="rowforVP">
                            <div class="minrowforVP">
                                <input
                                    type="radio"
                                    class="check6"
