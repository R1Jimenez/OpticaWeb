...
<template>
    <div class="CortesCajaPrinc">
        <Header />
        <div class="CortesCajaCont">
            <NavBar />
            <div class="CortesCajaUsages">
                <div class="CortesCajaEdsPrinc">
                    <div class="EdsCCPHeader">
                        <span>Reportes - Cortes de Caja</span>
                    </div>
                    <div class="FoGridCC">
                        <text>Formato:</text>
                        <div class="rowforCC">
                            <div class="minrowforCC">
                                <input
                                    type="radio"
                                    class="check8"
